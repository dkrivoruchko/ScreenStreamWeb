...
const index = readFileSync('src/client/index.html').toString().replace('%TURNSTYLE_SITE_KEY%', process.env.TURNSTYLE_SITE_KEY);
...
const expressApp = express()
  ...
  .use((req, res, next) => {
    res.append('Access-Control-Allow-Origin', ['https://www.datadoghq-browser-agent.com', 'https://cdn.socket.io', 'https://challenges.cloudflare.com']);
    next();
  })
